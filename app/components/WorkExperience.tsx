...
const WorkExperience = (props: Props) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex justify-center w-full space-x-5 overflow-x-scroll p-0 snap-x snap-mandatory -mb-16 scrollbar-thumb-green-300/80 scrollbar-thin scrollbar-track-gra/20"
        id="cards"
      >
        <ExperienceCard />
        <ExperienceCard />
