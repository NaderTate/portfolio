...
const Projects = (props: Props) => {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen flex flex-col relative text-left xl:flex-row max-w-full justify-evenly mx-auto items-center z-0"
    >
      ...
      <div className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20">
        {projects.map((_, i) => {
          return (
            <div className="p-20 rounded-xl shadow-xl mx-5 my-10 flex-shrink-0 snap-center w-screen md:p-44 h-screen flex flex-col items-center justify-center space-y-5">
              <motion.img
